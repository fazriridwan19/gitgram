...
import '../model_user_api/github_user_model.dart';
import '../model_user_api/github_user_repos_model.dart';
...
class GithubAPI {
  ...
  static Future<List<UserReposModel>> _processResponse2(
    ...
    return jsonResponse.map((p) => UserReposModel.fromJson(p)).toList();
  }
  ...
  static Future<List<UserDetailModel>> _processResponse3(
    ...
    final body = response.body;
    List jsonResponse = json.decode(body);
    return jsonResponse.map((p) => UserDetailModel.fromJson(p)).toList();
  }

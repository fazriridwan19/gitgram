...
import '../hive_model/account_model.dart';
...
class HiveDatabase {
  ...
  void updateHistory(
      String username, String password, String _search, String image) {
  ...
  void updateImage(
      String username, String password, String history, String newImage) {
    for (int i = 0; i < getLength(); i++) {
      if (username == _localDB.getAt(i)!.username) {
        _localDB.putAt(
            i,
